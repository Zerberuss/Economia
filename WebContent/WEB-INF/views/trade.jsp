	              ...
	              <form class="form-horizontal" method="post" action="${formAction}">
					<fieldset>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-7">
						    <div class="input-group">
						      <input id="trade.wood" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="wood" class="form-control" placeholder="0" min=0 type="number" value="<c:out value="0"/>">
						...
						<div class="form-group">
						  ...
						  <div class="col-md-7">
						    <div class="input-group">
						      <input id="trade.stone" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="stone" class="form-control" placeholder="0" min=0 type="number" value="<c:out value="0"/>">
						...
						<div class="form-group">
						  ...
						  <div class="col-md-7">
						    <div class="input-group">
						      <input id="trade.food" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="food" class="form-control" placeholder="0" min=0 type="number" value="<c:out value="0"/>">
						...
						<div class="form-group">
						  ...
						  <div class="col-md-6">
						    <div class="input-group">
						      <input id="trade.price" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="price" class="form-control" placeholder="0" min=0 type="number" value="<c:out value="0"/>">
